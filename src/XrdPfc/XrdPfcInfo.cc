...
{
   TraceHeader trace_pfx("Info:::Write()", dname, fname);
...
bool Info::Read(XrdOssDF *fp, const char *dname, const char *fname)
{
   ...
   // Wait, how about Purge, and LocalFilePath, Stat? XXXX-CKSUM

   TraceHeader trace_pfx("Info:::Read()", dname, fname);
...
{
   TraceHeader trace_pfx("Info:::ReadV3()", dname, fname);
...
bool Info::ReadV2(XrdOssDF* fp, const char *dname, const char *fname)
{
   ...
   TraceHeader trace_pfx("Info:::ReadV2()", dname, fname);
...
bool Info::ReadV1(XrdOssDF* fp, const char *dname, const char *fname)
{
   ...
   TraceHeader trace_pfx("Info:::ReadV1()", dname, fname);
